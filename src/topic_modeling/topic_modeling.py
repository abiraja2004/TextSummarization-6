...
def print_topics(corpus, model_type='lsi', total_topics=1, weight_threshold=0.0001, display_weights=False, num_terms=None):
    if model_type == 'lsi':
        ...
        print_topics_from_list(topic_list=topic_list, total_topics=total_topics, weight_threshold=weight_threshold,
                               display_weights=display_weights, num_terms=num_terms)
    else:
